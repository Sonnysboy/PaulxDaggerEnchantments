...
public class EnchantmentArmored extends
        EnchantmentBase {



    private static final EnumEnchantmentType TYPE = EnumHelper.addEnchantmentType("PXDE_ARMORED", new Predicate<Item>() {
        @Override
    ...
    public EnchantmentArmored() {
        super("armored", Rarity.UNCOMMON, TYPE,
